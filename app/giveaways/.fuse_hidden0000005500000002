...
const TRUST_ITEMS = ['Clear limits', 'Published winners', 'Points-based', 'Members only'];
        ...
        <div className="relative mx-auto max-w-7xl px-5 pt-12 pb-8 sm:px-6 sm:pt-20 sm:pb-12 lg:px-8 lg:pt-24 lg:pb-16">
          <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-12 lg:gap-14">
            ...
            <div className="text-center lg:col-span-7 lg:text-left">
              ...
              {/* Trust line — single row (no per-item icon for consistency) */}
              <div className="mt-7 flex items-center justify-center gap-x-1.5 whitespace-nowrap text-[11px] text-[#667085] sm:gap-x-2 sm:text-[12.5px] lg:justify-start">
                {TRUST_ITEMS.map((t, i) => (
