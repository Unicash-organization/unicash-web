...
import { type CategoryKey, type FaqItem, FAQ_DATA } from './faq-data';
...
// CategoryKey, FaqItem, FAQ_DATA are imported from ./faq-data (shared with the
// server-rendered FAQPage JSON-LD in app/faq/page.tsx).
type CategoryDef = {
  key: CategoryKey;
  label: string;
  chip: string;
