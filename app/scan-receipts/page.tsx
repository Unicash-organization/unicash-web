  ...
  return (
    <div className="bg-white" style={{ color: BRAND.ink }}>
      ...
      >
        ...
        />
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-12 px-8 pb-16 pt-12 sm:px-6 sm:pb-20 sm:pt-16 md:grid-cols-12 md:gap-8 lg:px-8 lg:pt-20">
      ...
      <section id="how-points-work" className="bg-white">
        <div className="mx-auto max-w-7xl px-8 py-16 sm:px-6 sm:py-20 lg:px-8">
      ...
      <section className="relative overflow-hidden" style={{ background: BRAND.lavender }}>
        ...
        />
        <div className="relative mx-auto max-w-7xl px-8 py-16 sm:px-6 sm:py-20 lg:px-8">
      ...
      {/* ============== FAQ ============== */}
      <section className="bg-white">
        <div className="mx-auto max-w-3xl px-8 py-16 sm:px-6 sm:py-20 lg:px-8">
