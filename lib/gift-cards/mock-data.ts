...
export const MOCK_REDEMPTIONS: Redemption[] = [
  {
    ...
    providerRef: 'prezzee_ord_2026_R8x912',
    codes: [
      { id: 'CD-1', code: 'COLES-2841-9F2K-1934', pin: '4821', expiresAt: isoPlus(365 * 3), status: 'delivered' },
    ],
  ...
  },
  {
    ...
    providerRef: 'prezzee_ord_2026_BP44192',
    codes: [
      { id: 'CD-2', code: 'BP-7204-AA12-3091', expiresAt: isoPlus(365 * 2), status: 'delivered' },
      { id: 'CD-3', code: 'BP-7204-AA12-3092', expiresAt: isoPlus(365 * 2), status: 'delivered' },
    ],
  ...
  },
  {
    ...
    providerRef: 'prezzee_ord_2026_88412',
    codes: [],
